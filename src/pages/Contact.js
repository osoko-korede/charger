  ...
  return (
    <div className='flex inset-0 justify-center items-center h-[80vh] px-10 md:px-0'>
        <div className='flex flex-col items-center gap-8  '>
            ...
            <p className='w-96 text-center'>The Contact page is being built. While you are here, you can check out other projects in <a href="https://osoko-korede.vercel.app/" rel='noopener' target='_blank' className='underline'>my portfolio.</a></p>
